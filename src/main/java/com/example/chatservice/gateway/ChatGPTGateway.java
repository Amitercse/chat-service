...
import com.example.chatservice.gateway.model.ChatGPTModel;
import com.example.chatservice.gateway.model.PromptMessage;
...
public class ChatGPTGateway implements ExternalServiceGateway<String> {
    ...
    private void buildChatGPTRequestModel(String prompt) {
        ...
        promptMessage.setContent(prompt+ " Provide response in json format");
